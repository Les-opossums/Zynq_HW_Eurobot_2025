...
proc create_root_design { parentCell } {
  ...
  set ETH_RESET [ create_bd_port -dir O ETH_RESET ]
  ...
  connect_bd_net -net processing_system7_0_ENET0_GMII_TXD [get_bd_ports ENET0_GMII_TXD_0] [get_bd_pins processing_system7_0/ENET0_GMII_TXD]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports ETH_RESET] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
